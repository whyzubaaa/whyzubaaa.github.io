...
const translations = {
  ru: {
    ...
    'p1-name': 'Доставка продуктов',
    'p1-desc': 'Мобильное приложение для доставки продуктов питания. Каталог, корзина, оформление заказа. Написано на Dart + Flutter.',
    'p2-name': 'Игра: Судья',
  ...
  en: {
    ...
    'about-bio-1':     'Hey! My name is <strong class="neon-text">Zubair</strong>. I\'m a web & mobile developer building websites and apps with JavaScript and Flutter.',
    'about-bio-2':     'I enjoy building things from scratch — from idea to finished product. I work across web and mobile platforms.',
    ...
    'p1-name': 'Food Delivery App',
    'p1-desc': 'Mobile app for ordering groceries. Product catalog, cart, and checkout flow. Built with Dart + Flutter.',
...
const typingPhrases = {
  ru: ['Web Developer', 'Flutter Dev', 'Mobile & Web', 'JS + Dart'],
  en: ['Web Developer', 'Flutter Dev', 'Mobile & Web', 'JS + Dart'],
};
